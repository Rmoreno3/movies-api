const moviesMocks = [
  {
    ...
    duration: 2028,
    contentRating: 'PG-13',
    tags: ['Drama|Musical|Romance', 'Drama|Romance'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Suspendisse potenti. In eleifend quam a odio. In hac habitagsse platea dictumst.\n\nMaecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.\n\nCurabitur gravida nisi at nibh. In hac habitagsse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.',
    duration: 1973,
    contentRating: 'PG-13',
    tags: [
      'Comedy',
  ...
  },
  {
    ...
    duration: 2004,
    contentRating: 'PG-13',
    tags: ['Sci-Fi|Thriller', 'Action', 'Action|Fantagsy|Thriller'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.\n\nIn hac habitagsse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.\n\nAliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.',
    duration: 2009,
    contentRating: 'PG-13',
    tags: [
      'Documentary|Drama',
  ...
  },
  {
    ...
    duration: 2014,
    contentRating: 'PG-13',
    tags: ['Western', 'Action|Thriller|War'],
  },
  {
    ...
    description:
      'In hac habitagsse platea dictumst. Etiam faucibus cursus urna. Ut tellus.\n\nNulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.',
    duration: 1938,
    contentRating: 'PG-13',
    tags: ['Action|Crime|Drama', 'Action|Adventure|Crime'],
  },
];
...
class MoviesServiceMock {
  ...
  async createMovie() {
    return Promise.resolve(moviesMocks[0].id);
  }
}
